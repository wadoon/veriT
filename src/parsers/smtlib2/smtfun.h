...
void smt2_declare_poly_fun(char *symbol,
                           T_SORT_LIST sort_list1,
                           T_SORT_LIST sort_list2,
                           T_SORT sort);
void smt2_define_fun(char *symbol,
...
T_TERM
smt2_iterm_app(char *str, T_TERM_LIST term_list, T_NUMERAL_LIST numeral_list);
...
T_TERM smt2_iterm_app_s(char *str,
