...
#ifndef __SIMPLEX_XX_H
#define __SIMPLEX_XX_H
...
TSstack(_LAsigned_xx, TLAsigned_xx); /* typedefs Tstack_LAsigned_xx */
...
extern Tsimplex_var simplex_xx_var_new(bool integer);

/**
   \author Pascal Fontaine
   \brief declare that a new variable may have bounds
   \param var the variable */
extern void simplex_xx_var_bounded(Tsimplex_var var);

/**
   \author David Deharbe
   \brief number of variables in the Simplex */
extern unsigned simplex_xx_var_n(void);
...
/**
   ...
   returned */
extern Tstatus simplex_xx_assert_upper_bound(
	Tsimplex_var i, TLAdelta_xx delta, Tlit lit);
...
/**
   ...
   \remark \c simplex_solve() \c is required for completeness if UNDEF is
   returned */
extern Tstatus simplex_xx_assert_lower_bound(
	Tsimplex_var i, TLAdelta_xx delta, Tlit lit);

/**
   \author Pascal Fontaine
   \brief solve the set of constraints */
extern Tstatus simplex_xx_solve(void);
...
extern void simplex_xx_simp_unbound(void);
...
extern void simplex_xx_constraint_push(
	unsigned n, Tsimplex_var* vars, TLAsigned_xx* coefs);
...
extern int simplex_xx_var_cmp(Tsimplex_var v1, Tsimplex_var v2);
...
/**
   ...
   \param[in] v1 a simplex variable
   \param[in] v2 a simplex variable */
extern bool simplex_xx_var_eq(Tsimplex_var v1, Tsimplex_var v2);
...
extern TLAdelta_xx* simplex_xx_var_assign(Tsimplex_var v);

/**
   \author David Deharbe
   \brief tests if a variable is an integer
   \param[in] v a simplex variable */
extern bool simplex_xx_var_integer(Tsimplex_var v);

/**
   \brief brings the current variable assignment of all simplex variables
   consistent with the current model. */
extern void simplex_xx_update_assign(void);

/**
   \brief Initializes the module */
extern void simplex_xx_init(void);

extern void simplex_xx_done(void);
